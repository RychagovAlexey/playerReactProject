...
export default function usePlayer() {
   ...
   return { backToInputHandler, playerStatus, playerStatusHandler,duration, handleTimeChange,formatTime, currentTime, volume, handleVolumeChange, player , currentLink}
}
